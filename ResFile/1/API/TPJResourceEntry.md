...
| **Method** | **Description** |
|:-----------|:----------------|
| _[ClearData](./TPJResourceEntry-ClearData.md)_ _[~>1.1]_ | Clears (deletes) the resource entry's raw data. |
...
| _[LoadDataFromFile](./TPJResourceEntry-LoadDataFromFile.md)_ _[~>1.1]_ | Loads the content of a file into the resource entry's raw data. |

...
* Finally we free all the objects. Freeing the [_TPJPipe_](../../../Docs/IOUtils/API/TPJPipe.md) and [_TPJFileHandle_](../../../Docs/IOUtils/API/TPJFileHandle.md) objects closes the pipe and file handles respectively.
